  ...
  return (
    <div
      className={`flex flex-col py-5 w-full items-center bg-white space-y-4 dark:bg-black dark:bg-opacity-30
        ...
        ${
          animate
            ? "animate-slideUp smd:animate-none md:animate-none lg:animate-none xl:animate-none 2xl:animate-none"
            : "hidden smd:flex md:flex lg:flex xl:flex 2xl:flex smd:animate-none md:animate-none lg:animate-none xl:animate-none 2xl:animate-none"
        }
        `}
    >
      <Logo
        imageCss="h-14 smd:h-20 md:h-auto"
        customCss={"hidden smd:flex md:flex lg:flex xl:flex 2xl:flex"}
      />

      <span
        className="text-2xl self-start px-5 dark:text-white
          smd:self-auto
          md:self-auto
          lg:self-auto
          xl:self-auto
      ...
      <span
        className="text-sm text-gray-500 dark:text-gray-300 self-start px-5 pb-5
          smd:self-auto
          md:self-auto
          lg:self-auto
          xl:self-auto
      ...
      <Scrollbar height="256px">
        <div
          className="flex flex-col w-full h-64 space-y-4 px-5
            md:px-10
            lg:px-16
            xl:px-20
            2xl:px-24
      ...
      <div
        className="flex flex-col w-full space-y-4 px-5
            md:px-10
            lg:px-16
            xl:px-20
            2xl:px-24
