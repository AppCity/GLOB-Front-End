...
const SignInScreen = (props) => {
  ...
  return (
    ...
    >
      ...
      <span
        className="text-2xl self-start dark:text-white
          smd:self-auto
          md:self-auto
          lg:self-auto
          xl:self-auto
      ...
      <span
        className="text-sm text-gray-500 dark:text-gray-300 self-start pb-5
          smd:self-auto
          md:self-auto
          lg:self-auto
          xl:self-auto
      ...
      <span className="text-xs text-gray-500 dark:text-gray-300 font-thin">
        OR SIGN IN WITH
      </span>
